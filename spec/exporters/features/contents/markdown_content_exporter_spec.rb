# spec/exporters/features/contents/markdown_content_exporter_spec.rb

require 'rails_helper'

require 'exporters/features/contents/markdown_content_exporter'

RSpec.describe MarkdownContentExporter do
  ...
  describe '::resource_class' do
    it { expect(described_class).to have_reader(:resource_class).with(MarkdownContent) }
  end # describe

  describe '::deserialize' do
    let(:attributes) { attributes_for(:markdown_content).stringify_keys }
  ...
  describe '::serialize' do
    ...
    let(:resource) { build(:markdown_content) }
