...
require 'delegates/features/imports_delegate'

RSpec.describe Features::ImportsDelegate, :type => :decorator do
  ...
  describe '#new' do
    ...
    it 'assigns a feature' do
      instance.new request

      expect(assigns[:resource]).to be_a Feature
    end # it
  end # describe
  ...
  describe '#new_template_path' do
    it { expect(instance).to have_reader(:new_template_path).with('admin/features/imports/new') }
  end # describe
end # describe
